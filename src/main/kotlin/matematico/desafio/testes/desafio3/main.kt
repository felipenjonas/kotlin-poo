...
*   entrar para o livro dos recordes, o Guinness Book.
...
*   da competição conseguem devorar. Ah, lembre que,
*   em troca da sua ajuda, você poderá comer quantas coxinhas conseguir.
*
* Entrada:
...
*   representando o número médio de coxinhas consumidas pelos participantes.
...
package matematico.desafio.testes.desafio3

fun main(){
    val stringData = readLine().toString()
    val splitData: List<String> = stringData.split(" ")
    val H = splitData[0].toInt()
    val P = splitData[1].toInt()
